const WPSD_Toast = (function() {
    ...
    function show(message, type = 'info', duration = 4000) {
        ...
        const colors = { success: '#166534', error: '#7f1d1d', info: '#1e40af', warning: '#92400e' };
        const bgs = { success: '#dcfce7', error: '#fee2e2', info: '#dbeafe', warning: '#fef3c7' };
    ...
    style.textContent = '@keyframes wpsd-slide-in{from{transform:translateX(100%);opacity:0}to{transform:translateX(0);opacity:1}}';
