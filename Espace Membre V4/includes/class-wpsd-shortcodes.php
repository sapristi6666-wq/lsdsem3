...
class WPSD_Shortcodes {
    ...
    public function register_assets() {
        ...
        wp_register_script('wpsd-profile', WPSD_URL . 'js/modules/wpsd-profile.js', ['wpsd-api', 'wpsd-utils', 'wpsd-toast'], time(), true);
        ...
        wp_register_script('wpsd-dashboard', WPSD_URL . 'js/dashboard.js', [
            ...
            'wpsd-demandes', 'wpsd-articles', 'wpsd-famille', 'wpsd-adhesion', 'wpsd-moderation', 'wpsd-profile'
        ], time(), true);
    }
}